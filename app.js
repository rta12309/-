...
const SOURCES = [
  ...
  },
  {
    ...
    apiExample: 'https://api.etherscan.io/v2/api?chainid=56&module=account&action=addresstokenbalance&address={address}',
  ...
  },
  {
    ...
    apiExample: 'https://api.etherscan.io/v2/api?chainid=137&module=account&action=addresstokenbalance&address={address}',
  ...
  },
  {
    ...
    apiExample: 'https://api.etherscan.io/v2/api?chainid=42161&module=account&action=addresstokenbalance&address={address}',
  ...
  },
  {
    ...
    apiExample: 'https://api.etherscan.io/v2/api?chainid=10&module=account&action=addresstokenbalance&address={address}',
  ...
  },
  {
    ...
    apiExample: 'https://api.etherscan.io/v2/api?chainid=43114&module=account&action=addresstokenbalance&address={address}',
    fetcher: (address) =>
  ...
  },
  {
    ...
    apiExample: 'https://api.etherscan.io/v2/api?chainid=8453&module=account&action=addresstokenbalance&address={address}',
...
async function fetchExplorerTokenBalances(chainId, address) {
  ...
  if (ETHERSCAN_API_KEY) {
    v2Query.set('apikey', ETHERSCAN_API_KEY);
  }
...
async function fetchEvmTokenBalancesFromTransfers(chainId, address) {
  ...
  const makeV2Url = (page) => {
    ...
    if (ETHERSCAN_API_KEY) q.set('apikey', ETHERSCAN_API_KEY);
